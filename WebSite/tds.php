...
<html>
  ...
  <body class="homepage is-preload">
    <div id="page-wrapper">
      ...
      <!-- TDS -->
      <section id="tdsec" class="wrapper style3">
        <div class="title">Total Dissolved Solids</div>
        <div class="container">
          <div class="row aln-center">
            ...
            <div class="col-6 col-12-medium">
              <section class="highlight"> 
                ...
                <?php
                  $dataNow1 = date('Y-m-d');  
                  $query4 = "SELECT data_send as date, tds FROM my_myfishtank.tds_tab WHERE FROM_UNIXTIME(data_send, '%Y-%m-%d') = '$dataNow1' ORDER BY data_send";
                  ...
                  if ($result_list->num_rows > 0) {
                    while($row4 = $result_list->fetch_assoc()) {
                      echo "<li class='style1'> At ".gmdate("H:i:s\ ", $row4['date'])."  TDS = ".$row4['tds']." ppm</li>";
                    }
                  }
                  echo '</ol>';
                ?>
