  	...
  	<body class="homepage is-preload">
        ...
        <script type="text/javascript">
			...
			$(document).on('submit','#addQuantities',function(e){
                ...
                alert(key + " " + k + " " + mg + " " + fe + " " + rinverdente + " " + npk + " ");
                if (key == "Pia12"){
                       $.ajax({
                         url:"add_quantities.php",
                         type:"post",
                       ...
                       $.ajax({
                         ...
                         success:function(data){
                           ...
                           if(status=='true'){
                            ...
                            row.row("[id='" + trid + "']").data([date, k, mg, fe, rinverdente, npk, button]);
                       ...
                       $.ajax({
                         ...
                         success:function(data){
                           ...
                           if(status=='true'){
                            ...
                            var row = table.row("[id='"+trid+"']");
                            row.row("[id='" + trid + "']").data([date, no2, no3, gh, kh, button]);
        				...
        				<form id="updateUser" >
                            ...
                            <div class="mb-3 row">
          					...
          					<div class="mb-3 row">
            					...
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="no2Field" name="nitriti" >
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="no3Field" class="col-md-3 form-label">Nitrati</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="no3Field" name="nitrati">
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="ghField" class="col-md-3 form-label">GH</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="ghField" name="gh">
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="khField" class="col-md-3 form-label">KH</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="khField" name="kh">
           						</div>
          					</div>
        				...
        				<form id="addQuantities" name="addQuantities" action="">
             				<div class="mb-3 row">
          					...
          					<div class="mb-3 row">
            					...
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="addKField" name="potassio" >
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="addMgField" class="col-md-3 form-label">Magnesio</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="addMgField" name="magnesio">
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="addFeField" class="col-md-3 form-label">Ferro</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="addFeField" name="ferro">
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="addRinverdenteField" class="col-md-3 form-label">Rinverdente</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="addRinverdenteField" name="rinverdente">
            					</div>
          					</div>
							<div class="mb-3 row">
            					<label for="addNPKField" class="col-md-3 form-label">Stick NPK</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="addNPKField" name="npk">
            					</div>
          					</div>
          					<div class="text-center">
            					<button type="submit" class="btn btn-primary">Submit</button>
        				...
        				<form id="updateQuantities" >
                            ...
                            <div class="mb-3 row">
          					...
          					<div class="mb-3 row">
            					...
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="kField" name="potassio" >
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="mgField" class="col-md-3 form-label">Magnesio</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="mgField" name="magnesio">
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="feField" class="col-md-3 form-label">Ferro</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="feField" name="ferro">
            					</div>
          					</div>
          					<div class="mb-3 row">
            					<label for="rinverdenteField" class="col-md-3 form-label">Rinverdente</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="rinverdenteField" name="rinverdente">
           						</div>
          					</div>
							<div class="mb-3 row">
            					<label for="npkField" class="col-md-3 form-label">Stick NPK</label>
            					<div class="col-md-9">
              						<input type="number" class="form-control" id="npkField" name="npk">
           						</div>
          					</div>
          					<div class="text-center">
            					<button type="submit" class="btn btn-primary">Submit</button>
