...
<html>
  	...
  	<body class="homepage is-preload">
    	<div id="page-wrapper">
              ...
              <div class="container">
                  <div class="carousel" data-flickity='{ "wrapAround": true, "autoPlay": true, "imagesLoaded":true }'>
                      ...
                      <div class="carousel-cell">
                          <img class="w3-image" src="images\riallestimento2.jpg">
                      </div>
                      <div class="carousel-cell">
                          <img class="w3-image" src="images\riallestimento3.jpg">
                      </div>
                  </div>
              </div>
          	</section>
        ...
        <script type="text/javascript">
			...
			$(document).on('click','.deleteBtnF',function(event){
                ...
                var id = $(this).data('id');
                $('#deleteFertilizationModal').modal('show');
                $('#idDQ').val(id);
            ...
            $(document).on('submit','#deleteQuantities',function(e){
      			e.preventDefault();
                var table = $('#fertilizationTable').DataTable();
                var key= $('#keyDField').val();
                var id= $('#idDQ').val();
                if (key == "Pia12"){
                      $.ajax({
                        url:"Fertilization/delete_quantities.php",
                        ...
                        success:function(data){
                          ...
                          if(status=='success'){
                            ...
                            //$("#"+id).closest('tr').remove();
                            table.draw();
                            $('#deleteFertilizationModal').modal('hide');
                          }else{
                            alert('Failed');
                            return;
                          }
        ...
        <script type="text/javascript">
    		...
    		$(document).on('click','.deleteBtn',function(event){
      			...
      			event.preventDefault();
                var id = $(this).data('id');
                $('#deleteValuesModal').modal('show');
                $('#idDeleteValues').val(id);
          	})
            $(document).on('submit','#deleteValues',function(e){
      			e.preventDefault();
                var table = $('#waterValuesTable').DataTable();
                var key= $('#keyDeleteValuesField').val();
                var id= $('#idDeleteValues').val();
                if (key == "Pia12"){
                      $.ajax({
    ...
    <script src="assets\js\flickity.pkgd.min.js"></script>
        ...
        <!-- Modal Delete Water Values -->
        <div class="modal fade" id="deleteValuesModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  			<div class="modal-dialog">
    			<div class="modal-content">
      				<div class="modal-header">
        				<h5 class="modal-title" id="exampleModalLabel">Delete Values</h5>
        				<button7 type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button7>
      				</div>
  				    <div class="modal-body">
        				<form id="deleteValues" >
          					<input type="hidden" name="idDeleteValues" id="idDeleteValues" value="">
                            <div class="mb-3 row">
            					<label for="keyDeleteValuesField" class="col-md-3 form-label">Key</label>
            					<div class="col-md-9">
              						<input type="password" class="form-control" id="keyDeleteValuesField" name="key" >
            					</div>
          					</div>
          					<div class="text-center">
        ...
        <!-- Modal Delete Fertilization -->
        <div class="modal fade" id="deleteFertilizationModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  			<div class="modal-dialog">
    			<div class="modal-content">
      				<div class="modal-header">
        				<h5 class="modal-title" id="exampleModalLabel">Delete Quantities</h5>
        				<button7 type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button7>
      				</div>
  				    <div class="modal-body">
        				<form id="deleteQuantities" >
          					<input type="hidden" name="idDQ" id="idDQ" value="">
                            <div class="mb-3 row">
            					<label for="keyDField" class="col-md-3 form-label">Key</label>
            					<div class="col-md-9">
              						<input type="password" class="form-control" id="keyDField" name="key" >
            					</div>
          					</div>
          					<div class="text-center">
            					<button type="submit" class="btn btn-primary">Delete</button>
