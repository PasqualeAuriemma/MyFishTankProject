    ...
    <div id="page-wrapper">
			...
			<!-- Header -->
				<section id="header" class="wrapper">
					...
					<!-- Logo -->
						<div id="logo">
							<h1><a href="index.html">AQUARIUM PIA12</a></h1>
				...
				<section id="intro" class="wrapper style1">
					...
					<div class="container">
                        ...
                        <?php
                         ...
                         $sql = "SELECT temperature FROM my_myfishtank.temp_tab ORDER BY data_arrive DESC limit 1";
                        ...
                        <ul class="actions">
							<li><a href="#" class="button style3 large">More Details</a></li>
						</ul>
					</div>
				</section>

			<!-- EC Conduttività Acqua -->
